...
You can create an arbitrary build environment by creating a custom `.env` file and isLoading it using [env-cmd](https://www.npmjs.com/package/env-cmd).
